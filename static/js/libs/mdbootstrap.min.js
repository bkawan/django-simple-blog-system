...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    easeInElastic: function(t, e, i, n, o) {
        ...
        if (r || (r = .3 * o), s < Math.abs(n)) {
            ...
            var a = r / (2 * Math.PI) * Math.asin(n / s);
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (!function(t) {
        ...
        i.isWindow = function(t) {
            ...
            for ("boolean" == typeof s && (u = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === c && (s = this, l--); c > l; l++)
                if (null != (a = arguments[l]))
                    for (o in a)
                        t = s[o], n = a[o], s !== n && (u && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, r = t && i.isArray(t) ? t : []) : r = t && i.isPlainObject(t) ? t : {}, s[o] = i.extend(u, r, n)) : void 0 !== n && (s[o] = n));
            return s
    ...
    return function(t, e, i, n) {
        ...
        function l(t, i, n, o) {
            ...
            function d(e, i, o) {
                var a,
                    r,
                    s = 0;
                do r = i + (o - i) / 2, a = l(r, t, n) - e, a > 0 ? o = r : i = r;
                                ...
                                for (var E in C)
                                    if ("element" !== E) {
                                        ...
                                        if (1 === g)
                                            ...
                                            if (A = I.startValue + L * M(g, c, L), !p && A === I.currentValue)
                                                continue
                                        }
        ...
        var d,
            ...
            m = !1;
        if (t.fn && t.fn.jquery ? (d = t, m = !0) : d = e.Velocity.Utilities, 8 >= f && !m)
        ...
        var x = b.CSS = {
            ...
            setPropertyValue: function(t, i, n, o, a) {
                ...
                if ("scroll" === i)
                    ...
                    if (x.Normalizations.registered[i] && (n = x.Normalizations.registered[i]("inject", t, n), i = x.Normalizations.registered[i]("name", t)), s = x.Names.prefixCheck(i)[0], 8 >= f)
                        try {
                            t.style[s] = n
                        } catch (u) {
                ...
                function t(t) {
                    ...
                    function g() {
                        ...
                        var s = 100,
                            l = {};
                        if (o && n)
                            l.emToPx = F.lastEmToPx, l.percentToPxWidth = F.lastPercentToPxWidth, l.percentToPxHeight = F.lastPercentToPxHeight;
                        else {
                        ...
                        for (var W in m) {
                            ...
                            if (r(a).isSVG || "tween" === X || x.Names.prefixCheck(X)[1] !== !1 || x.Normalizations.registered[X] !== n) {
                                ...
                                if (N = f(W, Y), Y = N[0], j = N[1], N = f(W, H), H = N[0].replace(/^([+-\/*])=/, function(t, e) {
                                    return $ = e, ""
                                }), B = N[1], Y = parseFloat(Y) || 0, H = parseFloat(H) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(W) ? (H /= 100, B = "em") : /^scale/.test(W) ? (H /= 100, B = "") : /(Red|Green|Blue)$/i.test(W) && (H = H / 100 * 255, B = "")), /[\/*]/.test($))
                                    B = j;
                                else if (j !== B && 0 !== Y)
                                    if (0 === H)
                                        B = j;
                                ...
                                b.debug && console.log("Skipping [" + X + "] due to a lack of browser support.")
                        }
                        l.element = a
                    }
            ...
            if (v.isWrapped(this) ? (s = !1, f = 0, p = this, l = this) : (s = !0, f = 1, p = w ? arguments[0].elements || arguments[0].e : arguments[0]), p = a(p)) {
                ...
                if (!/^(stop|finish)$/i.test(m) && !d.isPlainObject(y)) {
                    ...
                    for (var T = P; T < arguments.length; T++)
                        v.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? v.isString(arguments[T]) || v.isArray(arguments[T]) ? y.easing = arguments[T] : v.isFunction(arguments[T]) && (y.complete = arguments[T]) : y.duration = arguments[T]
                }
                var E = {
                    promise: null,
                    resolver: null,
    ...
    var n = i.helpers = {},
        ...
        A = (n.calculateScaleRange = function(t, e, i, n, a) {
            ...
            for (var d = Math.abs(h - u), f = T(d), p = Math.ceil(h / (1 * Math.pow(10, f))) * Math.pow(10, f), v = n ? 0 : Math.floor(u / (1 * Math.pow(10, f))) * Math.pow(10, f), m = p - v, g = Math.pow(10, f), w = Math.round(m / g); (w > s || s > 2 * w) && !l;)
                if (w > s)
                    g *= 2, w = Math.round(m / g), w % 1 !== 0 && (l = !0);
                else if (a && f >= 0) {
                    if (g / 2 % 1 !== 0)
                        break;
    ...
    i.instances = {}, i.Type = function(t, e, n) {
        ...
        if (n.prototype = a(e.prototype), r(n.prototype, t), n.extend = i.Type.extend, t.name || e.prototype.name) {
            ...
            v("Name not provided for this chart, so it hasn't been registered");
        return e
        ...
        buildYLabels: function() {
            ...
            for (var t = x(this.stepValue), e = 0; e <= this.steps; e++)
                this.yLabels.push(A(this.templateString, {
        ...
        calculateXLabelRotation: function() {
            ...
            if (this.xScalePaddingRight = e / 2 + 3, this.xScalePaddingLeft = t / 2 > this.yLabelWidth ? t / 2 : this.yLabelWidth, this.xLabelRotation = 0, this.display) {
                var a,
                    o = $(this.ctx, this.font, this.xLabels);
                this.xLabelWidth = o;
                for (var s = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6; this.xLabelWidth > s && 0 === this.xLabelRotation || this.xLabelWidth > s && this.xLabelRotation <= 90 && this.xLabelRotation > 0;)
                    a = Math.cos(C(this.xLabelRotation)), i = a * t, n = a * e, i + this.fontSize / 2 > this.yLabelWidth && (this.xScalePaddingLeft = i + this.fontSize / 2), this.xScalePaddingRight = this.fontSize / 2, this.xLabelRotation++, this.xLabelWidth = a * o;
        ...
        setScaleSize: function() {
            var e,
                ...
                a = this.width,
                l = 0;
            for (this.ctx.font = j(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++)
                e = this.getPointPosition(i, t), n = this.ctx.measureText(A(this.templateString, {
                    value: this.labels[i]
                    ...
                    if (i > 0) {
                        ...
                        if (this.lineWidth > 0)
                            if (t.strokeStyle = this.lineColor, t.lineWidth = this.lineWidth, this.lineArc)
                                ...
                                t.beginPath();
                                for (var r = 0; r < this.valuesCount; r++)
                                    a = this.getPointPosition(r, this.calculateCenterOffset(this.min + i * this.stepValue)), 0 === r ? t.moveTo(a.x, a.y) : t.lineTo(a.x, a.y);
        ...
        getBarsAtEvent: function(t) {
            for (var a, e = [], n = i.getRelativePosition(t), o = function(t) {
                ...
                for (a = 0; a < this.datasets[r].bars.length; a++)
                    if (this.datasets[r].bars[a].inRange(n.x, n.y))
                        return i.each(this.datasets, o), e;
            return e
        },
    ...
    e = function() {
        ...
        return o.prototype.defaults = {
            ...
            if (null == t && (t = this.element), 1 === t.nodeType) {
                for (t = t.parentNode || t, o = t.querySelectorAll("." + this.config.boxClass), a = [], i = 0, n = o.length; n > i; i++)
                    e = o[i], r.call(this.all, e) < 0 ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0), a.push(this.scrolled = !0)) : a.push(void 0);
                return a
            }
            ...
            for (i in e)
                o = e[i], t["" + i] = o, n.push(function() {
                    var e,
                        ...
                        r,
                        s;
                    for (r = this.vendors, s = [], e = 0, n = r.length; n > e; e++)
                        a = r[e], s.push(t["" + a + i.charAt(0).toUpperCase() + i.substr(1)] = o);
                    return s
                }.call(this));
            return n
            ...
            var i,
                ...
                s,
                l;
            for (s = n(t), r = s.getPropertyCSSValue(e), a = this.vendors, i = 0, o = a.length; o > i; i++)
                l = a[i], r = r || s.getPropertyCSSValue("-" + l + "-" + e);
            return r
    ...
    return t.init = function(t) {
        ...
        for (var n, o, a = 0, r = t.length; r > a; a++)
            n = t[a], o = n.tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(o) && (d[o](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
            ...
            function l(e) {
                ...
                if (!m.is("body") && m[0].scrollHeight > m[0].clientHeight && (v = m[0].scrollTop), c + r.innerWidth() > t(window).width() ? h = "right" : c - r.innerWidth() + n.innerWidth() < 0 && (h = "left"), u + r.innerHeight() > i)
                    if (u + l - r.innerHeight() < 0) {
                        ...
                        p || (p += l), p -= r.innerHeight();
                if ("left" === h)
                    d = o.gutter, f = n.position().left + d;
                else if ("right" === h) {
...
dropdownSelectors.on({
    ...
    function st(t, e) {
        ...
        if (e.eventType != j && (o > X || i.velocity === n)) {
            ...
            a = i.velocity, r = i.velocityX, s = i.velocityY, c = i.direction;
    ...
    function Rt(t, e) {
        ...
        for (o = 0; o < r.length;)
            n[r[o].identifier] && s.push(r[o]), e & (B | j) && delete n[r[o].identifier], o++;
    ...
    ae.prototype = {
        ...
        process: function(t) {
            ...
            if (this._input = t, !n || !i || t.eventType & (B | j) && !o)
                this.reset();
        ...
        recognize: function(t) {
            ...
            if (!e.stopped) {
                ...
                for (var a = 0; a < n.length;)
                    i = n[a], e.stopped === ye || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (Jt | te | ee) && (o = e.curRecognizer = i), a++
            }
        },
        get: function(t) {
            if (t instanceof ae)
            ...
            e = t.extend(i, e), t(this).each(function() {
                ...
                o.on("click", function() {
                    ...
                    if ("touch" == i.gesture.pointerType) {
                        ...
                        if ("left" === e.edge && (r > e.menuWidth ? r = e.menuWidth : 0 > r && (r = 0)), "left" === e.edge)
                            r < e.menuWidth / 2 ? s = !1 : r >= e.menuWidth / 2 && (s = !0), n.css("transform", "translateX(" + (r - e.menuWidth) + "px)");
                        else {
        ...
        i = function(t, i) {
            ...
            var o = {},
                ...
                r = function() {
                    ...
                    for (var e in n)
                        n.hasOwnProperty(e) && (o[e] = i && "undefined" != typeof i[e] ? i[e] : n[e], "function" == typeof o[e] && (o[e] = o[e].bind(this)));
            ...
            b = y.prototype = {
                ...
                set: function(e, i, n) {
                    ...
                    if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
                        r || (s[e] = i);
                        for (o in s)
                            a = s[o], o in b.component.item && (void 0 === a && (a = null), b.component.set(o, a, n)), ("select" == o || "clear" == o) && g.val("clear" == o ? "" : b.get(o, v.format)).trigger("change");
                        b.render()
                    }
    ...
    a.prototype.set = function(t, e, i) {
        ...
        var o,
            ...
            u = this.item.view;
        if (l || c) {
            for (c ? (a = i.year, r = i.month, s = i.date) : (a = +i[0], r = +i[1], s = +i[2]), n && n.nav && u && u.month !== r && (a = u.year, r = u.month), o = new Date(a, r + (n && n.nav ? n.nav : 0), 1), a = o.getFullYear(), r = o.getMonth(); new Date(a, r, s).getMonth() !== r;)
                s -= 1;
            i = [a, r, s]
        }
        return i
        ...
        if ((!n || !n.nav && !n.defaultValue) && (!l && a.disabled(i) || l && a.disabled(i) && (v || c || u) || !l && (i.pick <= h.pick || i.pick >= d.pick)))
            for (l && !v && (!u && s > 0 || !c && 0 > s) && (s *= -1); a.disabled(i) && (Math.abs(s) > 1 && (i.month < r.month || i.month > r.month) && (i = r, s = s > 0 ? 1 : -1), i.pick <= h.pick ? (f = !0, s = 1, i = a.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : -1)])) : i.pick >= d.pick && (p = !0, s = -1, i = a.create([d.year, d.month, d.date + (i.pick === d.pick ? 0 : 1)])), !f || !p);)
    ...
    function C(e, n) {
        ...
        var R,
            ...
            D,
            W,
            O = t('<div class="clockpicker-tick"></div>');
        if (n.twelvehour)
            for (R = 1; 13 > R; R += 1)
                F = O.clone(), D = R / 6 * Math.PI, W = m, F.css("font-size", "140%"), F.css({
        ...
        for (R = 0; 60 > R; R += 5)
            F = O.clone(), D = R / 30 * Math.PI, F.css({
    ...
    C.DEFAULTS = {
        ...
        }, this), 100))), this[this.currentView] = v, this[s ? "spanHours" : "spanMinutes"].html(d(v)), !o)
    ...
    var t = function(t, e, i, n) {
            ...
            ne = {
                ...
                init: function() {
                    if (!c && !u) {
                        ...
                        var h = "pswp--open ";
                        for (l.mainClass && (h += l.mainClass + " "), l.showHideOpacity && (h += "pswp--animate_opacity "), h += O ? "pswp--touch" : "pswp--notouch", h += _.animationName ? " pswp--css_animation" : "", h += _.svg ? " pswp--svg" : "", o.addClass(t, h), a.updateSize(), p = -1, bt = null, i = 0; s > i; i++)
                            Ft((i + p) * yt.x, k[i].el.style);
                ...
                updateCurrItem: function(t) {
                    if (0 !== bt) {
                        ...
                        if (!(t && 2 > i)) {
                            ...
                            for (var n = 0; i > n; n++)
                                bt > 0 ? (e = k.shift(), k[s - 1] = e, p++, Ft((p + 2) * yt.x, e.el.style), a.setContent(e, d - i + n + 1 + 1)) : (e = k.pop(), k.unshift(e), p--, Ft(p * yt.x, e.el.style), a.setContent(e, d + i - n - 1 - 1));
                            if (nt && 1 === Math.abs(bt)) {
                                var o = Ke(P);
                ...
                updateSize: function(e) {
                    if (!wt && l.modal) {
                        var i = o.getScrollY();
                        if (H !== i && (t.style.top = i + "px", H = i), !e && Ct.x === window.innerWidth && Ct.y === window.innerHeight)
                            return;
                    ...
                    if (vt.x = a.scrollWrap.clientWidth, vt.y = a.scrollWrap.clientHeight, Zt(), yt.x = vt.x + Math.round(vt.x * l.spacing), yt.y = vt.y, Dt(yt.x * mt), At("beforeResize"), void 0 !== p) {
                        for (var n, r, c, u = 0; s > u; u++)
                            n = k[u], Ft((u + p) * yt.x, n.el.style), c = d + u - 1, l.loop && Je() > 2 && (c = Pt(c)), r = Ke(c), r && (S || r.needsUpdate || !r.bounds) ? (a.cleanSlide(r), a.setContent(n, c), 1 === u && (a.currItem = r, a.updateCurrZoomItem(!0)), r.needsUpdate = !1) : -1 === n.index && c >= 0 && a.setContent(n, c), r && r.container && (si(r, vt), hi(r), Rt(r));
                        S = !1
                    }
                ...
                if (K) {
                    ...
                    if (0 !== t)
                        if (zt(re, K[0]), le.x = re.x - ce.x, le.y = re.y - ce.y, J && t > 1) {
                            if (ce.x = re.x, ce.y = re.y, !le.x && !le.y && xe(K[1], se))
                                return;
                            ...
                            if (o > i)
                                ...
                                i > r && (n = (i - r) / (6 * o), n > 1 && (n = 1), i = r + n * o);
                            0 > n && (n = 0), tt = e, Le(re, se, me), dt.x += me.x - we.x, dt.y += me.y - we.y, zt(we, me), pt.x = Wt("x", i), pt.y = Wt("y", i), N = i > y, y = i, Ot()
                        } else {
                            if (!at)
                                return;
                            if (rt && (rt = !1, Math.abs(le.x) >= ae && (le.x -= K[0].x - ue.x), Math.abs(le.y) >= ae && (le.y -= K[0].y - ue.y)), ce.x = re.x, ce.y = re.y, 0 === le.x && 0 === le.y)
                                return;
            ...
            Ve = function(t) {
                ...
                if (0 === c && ($ = !1, o.unbind(window, v, a), ke(), J ? u = 0 : -1 !== ge && (u = It() - ge)), ge = 1 === c ? It() : -1, r = -1 !== u && 150 > u ? "zoom" : "swipe", J && 2 > c && (J = !1, 1 === c && (r = "zoomPointerUp"), At("zoomGestureEnded")), K = null, U || Q || ot || B)
                    if (ee(), V || (V = Ne()), V.calculateSwipeSpeed("x"), B) {
                        ...
                        if (!ot)
                            return "swipe" !== r ? void qe() : void (!G && y > a.currItem.fitRatio && Be(V))
                    }
            },
            Ne = function() {
                var t,
        ...
        var Qe,
            ...
            ei = function(e, i, n, r) {
                ...
                if (!c || !s || void 0 === s.x)
                    return At("initialZoom" + (n ? "Out" : "In")), y = e.initialZoomLevel, zt(pt, e.initialPosition), Ot(), t.style.opacity = n ? 0 : 1, Mt(1), void (c ? setTimeout(function() {
                        u()
                    }, c) : u());
                var f = function() {
                    var i = h,
                    ...
                    e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (y = s.w / e.w, pt.x = s.x, pt.y = s.y - W, a[r ? "template" : "bg"].style.opacity = .001, Ot()), te("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), r && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                        ...
                        if (At("initialZoom" + (n ? "Out" : "In")), n) {
                            ...
                            y = e.initialZoomLevel, zt(pt, e.initialPosition), Ot(), Mt(1), r ? t.style.opacity = 1 : Mt(1), Qe = setTimeout(u, c + 20)
                    }, n ? 25 : 90)
                };
                f()
            },
        ...
        kt("Controller", {
            publicMethods: {
                ...
                initController: function() {
                    o.extend(l, oi, !0), a.items = Ue = i, Ke = a.getItemAt, Je = l.getNumItemsFn, ti = l.loop, Je() < 3 && (l.loop = !1), Et("beforeChange", function(t) {
                        ...
                        for (var t, e = 0; e < Ue.length; e++)
                            t = Ue[e], t.container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
                        ni = null
                    })
                },
                ...
                setContent: function(t, e) {
                    ...
                    if (!r.src && r.html && (r.html.tagName ? s.appendChild(r.html) : s.innerHTML = r.html), ui(r), si(r, vt), !r.src || r.loadError || r.loaded)
                        r.src && !r.loadError && (n = o.createEl("pswp__img", "img"),
                        ...
                        if (r.loadComplete = function(i) {
                            if (c) {
                                if (t && t.index === e) {
                                    if (ui(i, !0))
                                        return i.loadComplete = i.img = null, si(i, vt), Rt(i), void (t.index === d && a.updateCurrZoomItem());
        ...
        kt("Tap", {
            publicMethods: {
                ...
                onTapRelease: function(t, e) {
                    if (e && !U && !q && !Kt) {
                        var i = e;
                        if (fi && (clearTimeout(fi), fi = null, Ce(i, pi)))
                            return void At("doubleTap", i);
                        if ("mouse" === e.type)
                            return void vi(t, e, "mouse");
            ...
            publicMethods: {
                ...
                handleMouseWheel: function(t) {
                    if (y <= a.currItem.fitRatio)
                        return l.modal && (!l.closeOnScroll || Kt || $ ? t.preventDefault() : M && Math.abs(t.deltaY) > 2 && (h = !0, a.close())), !0;
                    if (t.stopPropagation(), mi.x = 0, "deltaX" in t)
                        1 === t.deltaMode ? (mi.x = 18 * t.deltaX, mi.y = 18 * t.deltaY) : (mi.x = t.deltaX, mi.y = t.deltaY);
                    else if ("wheelDelta" in t)
                        t.wheelDeltaX && (mi.x = -.16 * t.wheelDeltaX), t.wheelDeltaY ? mi.y = -.16 * t.wheelDeltaY : mi.y = -.16 * t.wheelDelta;
                    else {
                        if (!("detail" in t))
                            return;
                        mi.y = t.detail
        ...
        var gi,
            ...
            Ri = function() {
                if (bi && clearTimeout(bi), Kt || $)
                    return void (bi = setTimeout(Ri, 500));
    ...
    var t = function(t, e) {
        var i,
            ...
            T = function(t) {
                ...
                for (var i, n, o = t.target || t.srcElement, a = o.getAttribute("class") || "", r = 0; r < B.length; r++)
                    i = B[r], i.onTap && a.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
                if (n) {
            ...
            R = function() {
                for (var t, e, i, n, o, a = "", r = 0; r < m.shareButtons.length; r++)
                    t = m.shareButtons[r], i = m.getImageURLForShare(t), n = m.getPageURLForShare(t), o = m.getTextForShare(t), e = t.url.replace("{{url}}", encodeURIComponent(n)).replace("{{image_url}}", encodeURIComponent(i)).replace("{{raw_image_url}}", i).replace("{{text}}", encodeURIComponent(o)), a += '<a href="' + e + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>", m.parseShareButtonOut && (a = m.parseShareButtonOut(t, a));
                l.children[0].innerHTML = a, l.children[0].onclick = O
            },
            F = function(t) {
                for (var i = 0; i < m.closeElClasses.length; i++)
                    if (e.hasClass(t, "pswp__" + m.closeElClasses[i]))
                        return !0
            },
            D = 0,
            W = function() {
                        ...
                        if (n)
                            for (var a = n.length, r = 0; a > r; r++) {
                                ...
                                for (var s = 0; s < B.length; s++)
                                    o = B[s], i.indexOf("pswp__" + o.name) > -1 && (m[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
                            }
                    };
                a(n.children);
        ...
        x.init = function() {
            ...
            if (!g)
                ...
                } else if (m.tapToToggleControls && (S ? x.hideControls() : x.showControls()), m.tapToClose && (e.hasClass(n, "pswp__img") || F(n)))
                    return void t.close()
...
var initPhotoSwipeFromDOM = function(t) {
    for (var e = function(t) {
            for (var o, a, r, s, e = t.childNodes, i = e.length, n = [], l = 0; i > l; l++)
                o = e[l], 1 === o.nodeType && (a = o.children[0], r = a.getAttribute("data-size").split("x"), s = {
        ...
        }, r = document.querySelectorAll(t), s = 0, l = r.length; l > s; s++)
        r[s].setAttribute("data-pswp-uid", s + 1), r[s].onclick = n;
    var c = o();
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function(t) {
    t.fn.sticky = function(e) {
        ...
        return this.each(function() {
            function f() {
                var n = d.scrollTop();
                if (s && "string" == typeof h)
                    var o = t(h).offset().top,
                        f = o - i - r;
                else if (s && "number" == typeof h)
                    var f = h;
                if (n > c) {
                    if (e.after(u).css({
                        position: "fixed",
            ...
            function i(i, n) {
                ...
                if (0 === i) {
                    if (!e.scrollbarYActive)
                        return !1;
                    if (0 === o && n > 0 || o >= e.contentHeight - e.containerHeight && 0 > n)
                ...
                if (0 === n) {
                    if (!e.scrollbarXActive)
                        return !1;
                    if (0 === a && 0 > i || a >= e.contentWidth - e.containerWidth && i > 0)
                        return !e.settings.wheelPropagation
                }
                return !0
            }
        ...
        function n(t, e) {
            ...
            function o(e, i) {
                ...
                if (n) {
                    ...
                    if (o > 0 && !(0 === n.scrollTop && i > 0 || n.scrollTop === o && 0 > i))
                        return !0;
                    var a = n.scrollLeft - n.clientWidth;
                    if (a > 0 && !(0 === n.scrollLeft && 0 > e || n.scrollLeft === a && e > 0))
                        return !0
                }
                return !1
            }
        ...
        function n(t, e, i, n) {
            function o(i, n) {
                var o = t.scrollTop,
                    ...
                    s = Math.abs(n);
                if (s > r) {
                    if (0 > n && o === e.contentHeight - e.containerHeight || n > 0 && 0 === o)
                        return !e.settings.swipePropagation
                } else if (r > s && (0 > i && a === e.contentWidth - e.containerWidth || i > 0 && 0 === a))
                    return !e.settings.swipePropagation;
                return !0
            }
            function l(e, i) {
        ...
        return this.$el = t(this), this.$document = t(document), this.SELS = {
            ...
            o.$document.on("click", e.CHIPS, function(i) {
                ...
                if (!t(i.target).is("input, textarea")) {
                    var s,
                        n = o.$document.find(e.CHIP + e.SELECTED_CHIP),
                        a = n.closest(e.CHIPS),
                    ...
                    if (n.length)
                        if (8 === i.which || 46 === i.which) {
                            ...
                            if (s = n.index() + 1, t(e.CHIP).removeClass("selected"), s > r)
