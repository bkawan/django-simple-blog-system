...
NUM_PAGES_OUTSIDE_RANGE = 4
ADJACENT_PAGES = 4


def ajax_paginator(context):
    """
    ...
    if pages <= LEADING_PAGE_RANGE_DISPLAYED + NUM_PAGES_OUTSIDE_RANGE + 1:
        ...
        page_range = [
            n for n in range(pages - TRAILING_PAGE_RANGE_DISPLAYED + 1, pages + 1) if n > 0 and n <= pages]
    ...
    # settings.TEMPLATE_CONTEXT_PROCESSORS beforehand
...
register.inclusion_tag('core/tags/paginator.html', takes_context=True)(ajax_paginator)
